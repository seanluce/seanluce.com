...
Add a comma to the very end of the line preceding your closing curly bracket '}' followed by two additional lines defining your 'subId' and 'anfRg' variables. Your JSON syntax is critical. Make sure your double quotes, commas, and curly braces are in order. The final result should look something like this: (I've highlighted the new comma and additional lines.)
